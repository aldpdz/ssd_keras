...
from light_networks.shufflenetv2_relu6_se_no_shuffle.utils import block
#from shufflenetV2.utils import block
#from classification_networks.shufflenetV2.utils import block
def relu6(x):
...
def ShuffleNetV2(include_top=True,
    ...
    x = Conv2D(filters=out_channels_in_stage[0], kernel_size=(3, 3), padding='same', use_bias=False, strides=(2, 2),
               activation=relu6, name='conv1')(img_input)
    ...
    if bottleneck_ratio < 2:
        ...
        k = 2048
    x = Conv2D(k, kernel_size=1, padding='same', strides=1, name='1x1conv5_out', activation=relu6)(x)
